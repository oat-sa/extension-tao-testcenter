...
interface TestCenterImportServiceInterface
{
    /**
     * Launch the import of a csv file located at $filePath
     *
     * @param $filePath
     * @param array $extraProperties Rdf properties that need to be injected ( custom metadata )
     ...
     *
     * @param TestCenterMapper $mapper
     * @return $this
     */
    public function setMapper(TestCenterMapper $mapper);
}