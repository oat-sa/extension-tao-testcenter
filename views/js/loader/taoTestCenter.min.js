...
).off(_ns).empty()}).on("render",function(){var self=this,$element=this.getElement();textConverter().then(function(labels){$.get(proctorFormUrl,function(formData){renderFormFromData($element,formData),$element.on("submit"+_ns,"form",function(e){var fields=$(this).serializeArray(),list=self.config.testCenterList,data={testCenters:list&&list.getSelection()};_.each(fields,function(field){data[field.name]=field.value}),$.post(proctorFormUrl,data,function(res){res.created?(feedback().success(labels.get("Proctor created")),self.destroy()):renderFormFromData($element,res)}),e.preventDefault()}).on("click","button.btn-diasble",function(){self.destroy()})})}).catch(
function(err){console.log(err)})}).init(config)}}),define("tpl!taoTestCenter/templates/proctorManager/counters",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){this.compilerInfo=[4,">= 1.0.0"],helpers=this.merge(helpers,Handlebars.helpers),data=data||{};var stack1,functionType="function",escapeExpression=this.escapeExpression,self=this;function program2(depth0,data){var stack1,helper,buffer="";return buffer+='<div class="',stack1=(helper=helpers.cls)?helper.call(depth0,{hash:{},data:data}):typeof(helper=depth0&&depth0.cls)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(
stack1)+'"><span class="text">',stack1=(helper=helpers.label)?helper.call(depth0,{hash:{},data:data}):typeof(helper=depth0&&depth0.label)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1)+'</span>: <span class="count">',stack1=(helper=helpers.count)?helper.call(depth0,{hash:{},data:data}):typeof(helper=depth0&&depth0.count)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1)+"</span></div>"}return(stack1=helpers.each.call(depth0,depth0,{hash:{},inverse:self.noop,fn:self.program(1,function(depth0,data){var stack1,buffer="";return buffer+="\n    ",!(stack1=helpers.if.call(
depth0,depth0&&depth0.count,{hash:{},inverse:self.noop,fn:self.program(2,program2,data),data:data}))&&0!==stack1||(buffer+=stack1),buffer+="\n"},data),data:data}))||0===stack1?stack1:""})}),define("tpl!taoTestCenter/templates/proctorManager/status",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){this.compilerInfo=[4,">= 1.0.0"],data=data||{};var stack1,buffer="",helperMissing=(helpers=this.merge(helpers,Handlebars.helpers)).helperMissing,escapeExpression=this.escapeExpression,functionType="function";return!(stack1=helpers.if.call(depth0,depth0&&depth0.authorized,{hash:{},inverse:this.noop,fn:this.program(1,
function(depth0,data){var helper,options,buffer="";return buffer+=escapeExpression((options={hash:{},data:data},(helper=helpers.__||depth0&&depth0.__)?helper.call(depth0,"Authorized",options):helperMissing.call(depth0,"__","Authorized",options)))+' <span class="icon icon-authorize"></span>'},data),data:data}))&&0!==stack1||(buffer+=stack1),buffer+="\n",!(stack1=helpers.if.call(depth0,depth0&&depth0.partially,{hash:{},inverse:this.noop,fn:this.program(3,function(depth0,data){var stack1,helper,options,buffer="";return buffer+='<span title="',stack1=(helper=helpers.testCenters)?helper.call(depth0,{hash:{},data:data}):typeof(helper=depth0&&depth0.testCenters
)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1)+'">'+escapeExpression((options={hash:{},data:data},(helper=helpers.__||depth0&&depth0.__)?helper.call(depth0,"Partially authorized",options):helperMissing.call(depth0,"__","Partially authorized",options)))+"</span>"},data),data:data}))&&0!==stack1||(buffer+=stack1),buffer})}),define("taoTestCenter/controller/ProctorManager/index",["lodash","jquery","i18n","layout/loading-bar","util/url","util/encode","ui/feedback","ui/dialog/confirm","ui/bulkActionPopup","ui/datalist","ui/button","taoTestCenter/component/proctorForm","taoProctoring/helper/textConverter",
"tpl!taoTestCenter/templates/proctorManager/counters","tpl!taoTestCenter/templates/proctorManager/status","ui/datatable"],function(_,$,__,loadingBar,urlHelper,encode,feedback,dialogConfirm,bulkActionPopup,datalist,buttonFactory,proctorForm,textConverter,counterTpl,statusTpl){"use strict";var indexUrl=urlHelper.route("index","TestCenter","taoTestCenter"),proctorsDataUrl=urlHelper.route("proctorAuthorizations","ProctorManager","taoTestCenter"),authorizeUrl=urlHelper.route("authorize","ProctorManager","taoTestCenter"),unauthorizeUrl=urlHelper.route("unauthorize","ProctorManager","taoTestCenter"),_modes_EMPTY=0,_modes_LIST=1,_modes_FORM=2
;return loadingBar.start(),{start:function(){textConverter().then(function(labels){var $container=$(".proctorManager-index"),$panelSelection=$(".test-center-panel"),$containerList=$(".proctor-list"),$containerForm=$(".proctor-create"),$noSelection=$(".proctor-default"),testCenters=$container.data("list"),pageMode=_modes_EMPTY,list=datalist({renderTo:$panelSelection,textNumber:__("Test sites"),labelText:__("Test site"),selectable:!0},testCenters);function request(url,selection,message){selection&&selection.length&&(loadingBar.start(),$.ajax({url:url,data:{testCenters:list.getSelection(),proctors:selection},dataType:"json",type:"POST",error:function(){
