define("tpl!taoTestCenter/component/proctorForm/form",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){this.compilerInfo=[4,">= 1.0.0"],data=data||{};var stack1,helper,buffer="";return buffer+='<div class="proctor-form section-container">\n    <div class="content-block">\n        ',!(stack1=(helper=(helpers=this.merge(helpers,Handlebars.helpers)).form)||"function"==typeof(helper=depth0&&depth0.form)?helper.call(depth0,{hash:{},data:data}):helper)&&0!==stack1||(buffer+=stack1),buffer+="\n    </div>\n</div>"})}),define("taoTestCenter/component/proctorForm",["lodash","jquery","i18n","helpers","users","ui/feedback"
,"ui/component","taoProctoring/helper/textConverter","tpl!taoTestCenter/component/proctorForm/form"],function(_,$,__,helpers,users,feedback,component,textConverter,formTpl){"use strict";var _ns=".proctor-form",proctorFormUrl=helpers._url("createProctorForm","ProctorManager","taoTestCenter"),proctorLoginCheckUrl=helpers._url("checkLogin","ProctorManager","taoTestCenter");function renderFormFromData($container,formData){$container.html(formTpl({form:formData.form})),users.checkLogin(formData.loginId,proctorLoginCheckUrl)}return helpers.init(),function(config){return component().on("destroy",function(){this.getElement().off(_ns).empty()}).on("render",function(
){var self=this,$element=this.getElement();textConverter().then(function(labels){$.get(proctorFormUrl,function(formData){renderFormFromData($element,formData),$element.on("submit"+_ns,"form",function(e){var fields=$(this).serializeArray(),list=self.config.testCenterList,data={testCenters:list&&list.getSelection()};_.each(fields,function(field){data[field.name]=field.value}),$.post(proctorFormUrl,data,function(res){res.created?(feedback().success(labels.get("Proctor created")),self.destroy()):renderFormFromData($element,res)}),e.preventDefault()}).on("click","button.btn-diasble",function(){self.destroy()})})}).catch(function(err){console.log(err)})}).init(
config)}}),define("tpl!taoTestCenter/templates/proctorManager/counters",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){this.compilerInfo=[4,">= 1.0.0"],helpers=this.merge(helpers,Handlebars.helpers),data=data||{};var stack1,functionType="function",escapeExpression=this.escapeExpression,self=this;function program2(depth0,data){var stack1,helper,buffer="";return buffer+='<div class="',stack1=(helper=helpers.cls)||typeof(helper=depth0&&depth0.cls)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1)+'"><span class="text">',stack1=(helper=helpers.label)||typeof(
...
serviceUrl=urlHelper.route("testCenter","TestCenter","taoTestCenter");boxes?update(boxes):(loadingBar.start(),list.setLoading(!0),$.ajax({url:serviceUrl,cache:!1,dataType:"json",type:"GET"}).done(function(response){boxes=response&&response.list,update(boxes)}))}}}),define("tpl!taoTestCenter/component/eligibilityEditor/layout",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){this.compilerInfo=[4,">= 1.0.0"],data=data||{};var stack1,helper,options,buffer="",helperMissing=(helpers=this.merge(helpers,Handlebars.helpers)).helperMissing,escapeExpression=this.escapeExpression,functionType="function";function program3(
depth0,data){return"flex-col-12"}function program5(depth0,data){return"flex-col-6"}return buffer+='<div class="eligibility-editor',!(stack1=helpers.if.call(depth0,depth0&&depth0.editingMode,{hash:{},inverse:this.noop,fn:this.program(1,function(depth0,data){return" editing"},data),data:data}))&&0!==stack1||(buffer+=stack1),buffer+='">\n    <h2 class="title">',stack1=(helper=helpers.title)||typeof(helper=depth0&&depth0.title)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1)+'</h2>\n\n    <div class="flex-grid ">\n        <div class="',!(stack1=helpers.if.call(depth0,depth0&&depth0.editingMode,{hash:{},
inverse:this.program(5,program5,data),fn:this.program(3,program3,data),data:data}))&&0!==stack1||(buffer+=stack1),buffer+=' tree-container eligible-delivery">\n            <label>'+escapeExpression((options={hash:{},data:data},(helper=helpers.__||depth0&&depth0.__)?helper.call(depth0,"Eligible Deliveries",options):helperMissing.call(depth0,"__","Eligible Deliveries",options)))+'</label>\n                <div id="',stack1=(helper=helpers.deliveryTreeId)||typeof(helper=depth0&&depth0.deliveryTreeId)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1)+'"></div>\n        </div>\n        <div class="',!(
stack1=helpers.if.call(depth0,depth0&&depth0.editingMode,{hash:{},inverse:this.program(5,program5,data),fn:this.program(3,program3,data),data:data}))&&0!==stack1||(buffer+=stack1),buffer+=' tree-container eligible-testTaker">\n            <label>'+escapeExpression((options={hash:{},data:data},(helper=helpers.__||depth0&&depth0.__)?helper.call(depth0,"Eligible Test Takers",options):helperMissing.call(depth0,"__","Eligible Test Takers",options)))+" ",!(stack1=helpers.if.call(depth0,depth0&&depth0.editingMode,{hash:{},inverse:this.noop,fn:this.program(7,function(depth0,data){var stack1,helper,options,buffer="";return buffer+=escapeExpression((options={hash:{},
data:data},(helper=helpers.__||depth0&&depth0.__)?helper.call(depth0,"for",options):helperMissing.call(depth0,"__","for",options)))+' <span class="delivery-name">',stack1=(helper=helpers.deliveryName)||typeof(helper=depth0&&depth0.deliveryName)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1)+"</span> :"},data),data:data}))&&0!==stack1||(buffer+=stack1),buffer+='</label>\n                <div id="',stack1=(helper=helpers.subjectTreeId)||typeof(helper=depth0&&depth0.subjectTreeId)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1
...
id:"import",icon:"import",title:__("Import"),label:__("Import"),action:function(){tableComponent.trigger("import",eligibilities)}}]),tableComponent=component({},{dataUrl:helpers._url("getEligibilities","TestCenterManager","taoTestCenter",{uri:testCenterId})}).on("render",function(){var self=this;this.$component.on("query.datatable",function(){self.trigger("loading")}).on("load.datatable",function(e){self.trigger("loaded")}).on("beforeload.datatable",function(e,dataSet){dataSet&&dataSet.data&&(eligibilities=dataSet.data)}).datatable({url:this.config.dataUrl,status:{empty:__("No Eligible Delivery yet"),available:__("Eligible Deliveries"),loading:__("Loading")
},tools:tools,model:[{id:"status",label:"",transform:function(value,row){return statusTpl(row)}},{id:"deliveryLabel",label:__("Delivery"),transform:function(value,row){return row.delivery.label}},{id:"testTakersCount",label:__("Eligible Test Takers"),transform:function(value,row){return row.testTakers&&row.testTakers.length?row.testTakers.length:0}},{id:"actions",label:__("Actions"),transform:function(value,row){return row.allowedToWrite=allowedToWrite,actionsTpl(row)}}],selectable:!1}).on("click",".actions button",function(e){e.preventDefault();var $button=$(this),itemId=$button.parents("[data-item-identifier]").data("item-identifier"),action=$button.data(
"action");self.trigger(action,itemId,eligibilities)})}).on("reload",function(){this.$component&&this.$component.datatable("refresh")})}}),define("tpl!taoTestCenter/component/eligibilityImport/layout",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){this.compilerInfo=[4,">= 1.0.0"],helpers=this.merge(helpers,Handlebars.helpers),data=data||{};var helper,buffer="";return buffer+='<div id="eligibility-import">\n    <div class="report-container">\n        <div class="section-header flex-container-full">\n            <h2>',buffer+=(0,this.escapeExpression)((helper=helpers.title)||"function"==typeof(
helper=depth0&&depth0.title)?helper.call(depth0,{hash:{},data:data}):helper)+'</h2>\n        </div>\n        <div class="main-container flex-container-full report"></div>\n    </div>\n    <div id="upload-container"></div>\n</div>'})}),define("taoTestCenter/component/eligibilityImport",["jquery","lodash","i18n","module","helpers","uri","ui/component","tpl!taoTestCenter/component/eligibilityImport/layout","ui/feedback","ui/report","layout/loading-bar","async","ui/modal","css!taoTestCenterCss/eligibilityEditor","ui/uploader"],function($,_,__,module,helpers,uri,component,layoutTpl,feedback,reportFactory,loadingBar,async){"use strict"
;var _ns=".eligibility-import",_fileTypeFilters=["text/csv","application/vnd.ms-excel"],_fileExtFilter=/.+\.(csv)$/,_modalDefaults={width:600};return function(datatable,testCenterId){var eligibilityImport,config={uploadUrl:helpers._url("import","TestCenterManager","taoTestCenter",{uri:testCenterId})};if(_.isEmpty(testCenterId))throw new TypeError("The eligibility provider needs to be initialized with a test center");var destroyModal=function(){eligibilityImport&&eligibilityImport.getElement()&&(datatable.trigger("reload"),eligibilityImport.getElement().modal("destroy").remove())};var initModal=function(modalConfig){var errors,$uploader,$reportContainer
;modalConfig=_.defaults(modalConfig||{},_modalDefaults),eligibilityImport&&eligibilityImport.getElement()&&eligibilityImport.getElement().addClass("modal").on("closed.modal",destroyModal).modal(modalConfig),errors=[],$uploader=$("#upload-container"),$reportContainer=$(".report-container"),$uploader.on("upload.uploader",function(e,file,data){return reportFactory({actions:[{id:"continue",icon:"right",title:"continue",label:__("Continue")}]},data.report).on("action-continue",function(){destroyModal()}).render($reportContainer.find(".report"))}).on("fail.uploader",function(e,file,err){errors.push(__("Unable to upload file %s : %s",file.name,err))}).on(
"end.uploader",function(){0<errors.length&&feedback().error(function(errors){return"<ul><li>"+errors.join("</li><li>")+"</li></ul>"}(errors),{encodeHtml:!1}),errors=[]}),$uploader.uploader({upload:!0,uploadUrl:config.uploadUrl,fileSelect:function(files,done){var givenLength=files.length;(files=_.filter(files,function(file){var checkType=file.type.replace(/("|')/g,"");return _.contains(_fileTypeFilters,checkType)||""===checkType&&_fileExtFilter.test(file.name)})).length!==givenLength&&feedback().error("Invalid files have been removed"),async.filter(files,function(file,cb){cb(!0)},done)}})};return eligibilityImport=component({add:function($container,options){
return this.on("render",function(){var self=this;options=_.defaults(options||{},this.config),initModal({width:650}),this.$component.on("click"+_ns,".actions .done",function(e){e.preventDefault(),destroyModal()}).on("click"+_ns,".actions .cancel",function(e){e.preventDefault(),destroyModal(),self.trigger("cancel")}),this.trigger("open")}).init({title:__("Import Eligibilities from csv file."),editingMode:!1}).render($container).resize()},resize:function(){return eligibilityImport.getElement().css({top:"40px","overflow-y":"auto"}),eligibilityImport.getElement().css("max-height",$(window).height()-2*parseInt(eligibilityImport.getElement().css("top"),10)+"px"),
this}},config).setTemplate(layoutTpl)}}),define("taoTestCenter/provider/eligibility",["jquery","lodash","helpers","core/promise"],function($,_,helpers,Promise){"use strict";var request=function(action,parameters){return $.ajax({url:helpers._url(action,"TestCenterManager","taoTestCenter"),data:parameters,dataType:"json",type:"POST"})};return function(testCenterId){if(_.isEmpty(testCenterId))throw new TypeError("The eligibility provider needs to be initialized with a test center");return{addEligibilities:function(eligibilities){return new Promise(function(resolve,reject){if(!_.isPlainObject(eligibilities))return reject(new TypeError("Invalid eligibility"))
